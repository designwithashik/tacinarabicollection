    ...
    <div className="group flex w-full min-w-0 flex-col overflow-hidden rounded-xl border border-[var(--brand-secondary)]/10 bg-[var(--brand-surface)] transition-all duration-200 ease-out md:hover:-translate-y-1 md:hover:shadow-md">
      ...
      <div className="flex flex-1 flex-col p-3 space-y-2">
          ...
          <div className="flex gap-1 flex-wrap mt-1">
            {sizes.map((size) => (
              <button
                ...
                type="button"
                className={clsx(
                  "interactive-feedback text-[11px] px-2 py-1 rounded-md border font-medium transition",
                  selectedSize === size
        ...
        <div className="flex gap-2 items-center mt-2">
          <div className="flex items-center border rounded-md px-2 py-1 border-[#e5d7cc] bg-white">
              <button
                type="button"
        ...
        {quantityFeedback ? (
          <p className="mt-1 text-xs font-semibold text-accent">{quantityFeedback}</p>
        ) : null}
