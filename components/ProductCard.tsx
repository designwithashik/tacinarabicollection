    ...
    <div className="group flex w-full min-w-0 flex-col overflow-hidden rounded-xl border border-[var(--brand-secondary)]/10 bg-[var(--brand-surface)] transition-all duration-200 ease-out md:hover:-translate-y-1 md:hover:shadow-md">
      ...
      >
        ...
        <div className="pointer-events-none absolute inset-x-3 bottom-3 rounded-lg bg-white/55 p-3 text-left backdrop-blur-sm">
          ...
          <p className="mt-0.5 text-[13px] font-medium text-charcoal transition-transform duration-200 group-hover:translate-y-[-1px] break-words line-clamp-2">
            {product.name}
          </p>
      ...
      <div className="flex flex-1 flex-col p-3 space-y-2">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          {typeof stockCount === "number" && stockCount <= 5 ? (
            <span className="rounded-full bg-white px-2 py-1 text-[10px] font-medium shadow-sm whitespace-nowrap">
              Limited
            </span>
          ) : null}
        </div>
