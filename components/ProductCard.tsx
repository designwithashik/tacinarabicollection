    ...
    <div className="group relative overflow-hidden rounded-3xl border border-[var(--brand-secondary)]/10 bg-[var(--brand-surface)] transition-all duration-500 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)]">
      <div className="relative overflow-hidden rounded-t-3xl">
        ...
        >
          ...
          <span className="absolute left-3 bottom-3 rounded-full border border-white/70 bg-white/90 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-ink">
            {statusLabel}
          </span>
        </div>
      ...
      <div className="p-6 space-y-4">
        ...
        <div>
          ...
          {sizeMissing ? <p className="mt-2 text-xs text-accent">Select a size to continue.</p> : null}
        </div>
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            {quantityFeedback ? <p className="mt-2 text-xs font-semibold text-accent">{quantityFeedback}</p> : null}
          </div>
