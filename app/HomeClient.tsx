...
export default function HomePage({
  ...
  return (
    <div
      className={clsx(
        "min-h-screen bg-[#F7F6F4] transition-opacity duration-300 ease-in-out",
    ...
    >
      ...
      <section className="relative">
        <div className="mx-auto max-w-6xl px-4 pb-5 pt-4 md:px-10">
          ...
          <div className="mx-auto max-w-6xl space-y-3 px-4 py-4">
            ...
            <div className="flex items-center justify-between">
              <p className="text-[13px] text-neutral-600">
                {visibleProducts.length} items • {sortOptions.find((option) => option.id === (filters.sort ?? "newest"))?.label ?? "Newest"}
              </p>
              <button
                type="button"
                onClick={() => openSheet("size")}
                className="flex items-center gap-2 rounded-full border border-neutral-300 px-3 py-1 text-[13px] transition hover:bg-neutral-900 hover:text-white"
              >
                Sort & Filters
