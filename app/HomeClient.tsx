...
export default function HomePage({
  ...
  return (
    <div
      className={clsx(
        "min-h-screen bg-[#F7F6F4] pb-24 transition-opacity duration-300 ease-in-out",
    ...
    >
      ...
      <section className="relative">
        <div className="mx-auto max-w-6xl px-4 pb-2 pt-4 md:px-10">
      ...
      <section className="bg-black py-2 text-white">
        <div className="mx-auto max-w-6xl overflow-hidden px-4">
          <div className="whitespace-nowrap animate-[marquee_20s_linear_infinite] text-[13px] font-medium tracking-wide">
        ...
        <AnimatedWrapper className="retail-section-enter" variant="section">
          <div className="mx-auto max-w-6xl space-y-3 px-4 py-4">
            ...
            <div className="flex items-center justify-between">
              <p className="text-[13px] text-neutral-600">Sort: {filters.sort ? sortOptions.find((option) => option.id === filters.sort)?.label ?? "Newest" : "Newest"}</p>
              <button
                type="button"
                onClick={() => openSheet("size")}
                className="flex items-center gap-2 rounded-full border border-neutral-300 px-3 py-1 text-[13px] whitespace-nowrap transition hover:bg-neutral-900 hover:text-white"
              >
                Filters
      ...
      <main id="product-grid" className="mx-auto mt-6 max-w-6xl px-4 pb-24">
      ...
      <footer className="mt-16 border-t border-neutral-200 bg-[#F3F2F0]">
        <div className="mx-auto grid max-w-6xl gap-8 px-4 pb-20 pt-14 md:grid-cols-3">
          <div>
