    ...
    >
      ...
      <section className="sticky top-0 z-30 border-b border-neutral-200 bg-white">
        <AnimatedWrapper className="retail-section-enter" variant="section">
          <div className="mx-auto max-w-6xl bg-[#F7F6F4] px-4 py-4 space-y-3">
            ...
            <div className="flex items-center justify-between">
              <span className="text-[13px] text-neutral-600">{sortOptions.find((option) => option.id === filters.sort)?.label ?? "Newest"}</span>
              <button
                type="button"
                onClick={() => openSheet("size")}
                className="flex items-center gap-2 rounded-full border px-3 py-1 text-[13px]"
              >
                Filters
      ...
      <main id="product-grid" className="mx-auto mt-4 max-w-6xl px-4 pb-24 pt-4">
        ...
        <section className="mt-12 space-y-1 text-[13px] leading-relaxed text-neutral-600">
      ...
      <footer className="border-t border-neutral-200 bg-white">
        <div className="mx-auto grid max-w-6xl gap-5 space-y-6 px-4 pb-16 pt-12 md:grid-cols-3 md:space-y-0">
          <div>
