              ...
              <div className="max-w-xl space-y-3 text-center text-white">
                ...
                <div className="flex justify-center">
                  <div className="w-full max-w-xs">
                    <button
                      type="button"
                      className="relative z-30 w-full rounded-full bg-black px-6 py-2 text-[14px] text-white transition hover:opacity-90"
                      onClick={(event) => {
                    ...
                    <button
                      type="button"
                      className="mt-3 w-full rounded-full border border-white bg-white/10 px-6 py-2 text-[14px] text-white backdrop-blur-sm transition hover:bg-white/20"
                      onClick={(event) => {
                        event.stopPropagation();
