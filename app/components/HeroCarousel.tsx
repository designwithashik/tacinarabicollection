          ...
          <div key={product.id} className="relative h-full min-w-full overflow-hidden">
            ...
            <div className="absolute inset-0 z-20 flex items-end justify-center px-6 pb-8 md:items-center md:pb-0">
              <div className="max-w-xl space-y-3 text-center text-white">
                <h2 className="text-[22px] font-semibold leading-tight tracking-tight sm:text-2xl md:text-3xl md:tracking-[0.5px]">
                ...
                <div className="flex justify-center">
                  <div className="w-full max-w-xs">
                    <button
                      type="button"
                      className="relative z-30 w-full rounded-full bg-black px-6 py-2 text-[14px] text-white"
                      onClick={(event) => {
                    ...
                    <button
                      type="button"
                      className="mt-3 w-full rounded-full border border-white bg-white/10 px-6 py-2 text-[14px] text-white backdrop-blur-sm transition-all duration-300 hover:bg-white hover:text-[var(--brand-primary)]"
                      onClick={(event) => {
                        event.stopPropagation();
