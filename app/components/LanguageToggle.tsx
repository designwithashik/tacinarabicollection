...
export default function LanguageToggle({ language, setLanguage }: Props) {
  ...
  return (
    <div className="relative inline-flex min-h-[44px] items-center rounded-full bg-[var(--brand-secondary)]/15 p-1">
      <div
      ...
      <button
        ...
        className="relative z-10 inline-flex min-h-[44px] min-w-[44px] items-center px-4 py-1 text-sm transition-colors duration-300"
      >
